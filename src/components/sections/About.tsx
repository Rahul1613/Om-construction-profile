  ...
  return (
    <section id="about" ref={sectionRef} className="section-padding bg-gray-50">
      <div className="container-width">
        <h2 className={`section-title scroll-animate ${isVisible ? 'visible' : ''}`}>About Us</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div className={`relative h-64 mb-6 rounded-lg overflow-hidden scroll-animate ${isVisible ? 'visible' : ''} delay-200`}>
              <Image
                src="/images/05_Site Office.png"
                alt="OM Construction site office"
                fill
                sizes="(max-width: 768px) 100vw, 50vw"
                className="object-cover"
              />
            </div>
            <p className={`text-gray-600 mb-4 leading-relaxed scroll-animate ${isVisible ? 'visible' : ''} delay-300`}>
            ...
            <p className={`text-gray-600 mb-4 leading-relaxed scroll-animate ${isVisible ? 'visible' : ''} delay-400`}>
              Our expertise spans thermal power plants, natural draft cooling towers (NDCT), 400/220 KV GIS substations, utility-scale solar parks, wind energy infrastructure, and industrial civil works. We have successfully delivered 32+ projects for major clients including ABB India, L&T, Alstom, TATA Projects, and Gamesa Renewable.
            </p>
            <p className={`text-gray-600 mb-6 leading-relaxed scroll-animate ${isVisible ? 'visible' : ''} delay-500`}>
            ...
            <div className={`grid grid-cols-2 gap-4 mt-6 scroll-animate ${isVisible ? 'visible' : ''} delay-600`}>
          ...
          <div className={`p-6 bg-white border border-gray-200 rounded-lg shadow-sm scroll-animate ${isVisible ? 'visible' : ''} delay-700`}>
